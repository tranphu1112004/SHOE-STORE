...
const TrendingBanner = [
  {
    ...
    title:
      "Inspired by our original tennis shoe, the Killshot 2 brings a fresh update with classic colours and a variety of textured leathers. To prove youre on top, the rubber gum sole adds the cherry on the bottom. You get courtside attitude with a modern touch.",
    link: "/product/1",
    buttonT: "MUA NGAY",
  },
];
        ...
        <div className="lg:md:text-center text-black text-2xl">
          <div>
            ...
            <p className="text-sm font-medium mb-4 ">
              Hãy khám phá và trải nghiệm ngay để tận hưởng sự khác biệt mà{" "}
              <span className="font-semibold">MONA SNE✭KER</span> mang lại!
            </p>
          </div>
        </div>
            ...
            <Link to="">
              <div key={index} className="relative w-full h-[450px] mb-4">
                ...
                <div className="absolute inset-0 flex flex-col top-[20%] items-center lg:md:items-start lg:md:w-2/4 md:lg:left-[60%] text-white">
                  ...
                  <p className="text-xs text-center w-3/4 text-white tracking-widest mb-8 lg:md:text-left">
                    {item.title}
                  </p>
                  <Link
                    to={item.link}
                    className="bg-red-600 px-10 py-2  text-white hover:bg-red-700 transition-colors duration-300"
                  >
                    {item.buttonT}
                  </Link>
                </div>
